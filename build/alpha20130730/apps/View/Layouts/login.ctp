...
<body>
	<div id="outer">
        <div id="header">
            <h1><a href="<?php echo Configure::read("root_url") ?>" title="Zenwork(alpha version)" class="Logo"><img src="<?php echo Configure::read("root_url") ?>/images/logo-zenwork.png" alt="Zenwork(alpha version)" /></a></h1>
