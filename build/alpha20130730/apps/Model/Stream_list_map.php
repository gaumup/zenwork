        ...
        public function save ($data=null, $validate=true, $fieldList=array()) {
            ...
            if ( isset($data['Stream_list_map']) ) {
                ...
                if ( $data['Stream_list_map']['lid'] == 1 ) { //if list id = 1 -> proceed
                    ...
                    $userLists = $streamListModel->getUsersLists(CakeSession::read('Auth.User.id'));
                ...
                if ( $isPermitted ) {
                    if ( isset($data['Stream_list_map']['parentID']) ) { //parent
                        if ( $data['Stream_list_map']['parentID'] != 0 ) {
                            $parent = $this->find('first', array(
                                'conditions' => array('Stream_list_map.sid' => $data['Stream_list_map']['parentID']) ,
                    ...
                    if ( isset($data['Stream_list_map']['offset']) && $data['Stream_list_map']['offset'] != 0 ) { //index changes
