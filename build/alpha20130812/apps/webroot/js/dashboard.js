    ...
    /* Today block js code */
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                if ( data.today.length == 0 ) {
                    Zenwork.Dashboard.pub('todayBlockLoad', '#zwAddNewTaskText', '#zwAddNewTaskCompact', '#myTaskStatisticChartBlock');
                }
                else {
                    Zenwork.Dashboard.pub('todayBlockLoad', '#zwAddNewTaskCompact', '#myTaskStatisticChartBlock', '#todayTaskListJScrollPane');
                }
            },
        ...
        $('.ZWAddNewBtn').bind('click', function (e) {
            Zenwork.Dashboard.pub('dashboardStartAddFirstTask');
            ...
            todayTaskList.tasklist('addNewStream', 
                ...
                function (stream) {
                    ...
                    stream.find('.StreamDetailsBtn').trigger('mousedown', function () {
                        Zenwork.Dashboard.pub('dashboardViewAddedFirstTask', '#streamDialogTitle', '#belongsToList', '#listSelection', '#tagBlock', '#timelineBlock');
                    });
                }
            );
            return false;
        ...
        //private method
            ...
            _initStreamDetailsControl: function (stream) {
                ...
                $('.StreamTimelineBlockCompletion').on('click', function (e) {
                    Core.Mediator.pub('afterClickFinishTask');
                ...
                $('.StreamTimelineBlockStartWorking').on('click', function (e) {
                    Core.Mediator.pub('afterClickStartWorking');
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            Core.Mediator.pub('finishTask', '.StreamTimelineBlockCompletion:first');
                        },
                        error: function (jqXHR, textStatus, errorThrown) {
                            if ( textStatus !== 'abort' ) {
                                alert('Really sorry for this, network error! Please try again!');
            ...
            _openStreamDetails: function (e, stream, aside, callback) {
                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        ...
                        Core.Mediator.pub('startWorkingTask', '.StreamTimelineBlockStartWorking:first');
                    },
                    error: function (jqXHR, textStatus, errorThrown) {
                        if ( textStatus !== 'abort' ) {
                            alert('Really sorry for this, network error! Please try again!');
