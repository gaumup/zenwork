...
Zenwork.List = {
    ...
    init: function () {
        ...
        createNewStreamListBtn.on('click', function (e) {
            Core.Mediator.pub('afterClickCreatePlan');
...
Zenwork.Popup = {
    ...
    preProcess: function (/*object {}*/pos, showOverlays) {
        Core.Mediator.pub('beforeShowStreamPopup');
...
Zenwork.StreamPopup = $.extend(true, {}, Zenwork.Popup, {
    ...
    close: function () {
        if ( !this.wrapper.hasClass('Hidden') ) {
            Core.Mediator.pub('beforeCloseStreamPopup');
            this._super.close.call(this);
            this.observer = null;
            Core.Mediator.pub('afterCloseStreamPopup');
        }
    },
