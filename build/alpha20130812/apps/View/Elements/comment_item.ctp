<?php
    ...
    $commentMsgShort = (strlen($commentMsg) < $maxlength ? $commentMsg : substr($commentMsg, 0, $maxlength).'... <a href="#" title="See more" class="SCommentViewFull">See more</a><input type="hidden" value="'.$commentMsg.'" />');
    print_r(
        ...
        '    </p>'.
        '    <p class="StreamCommentMsg">'.nl2br($commentMsgShort).'</p>'.
