...
<div class="StreamBlock StreamTimelineBlock <?php if ( $timeline['completed'] ) : ?>StreamTimelineBlockDone<?php endif; ?>" id="streamTimelineBlock<?php echo $timeline['id']; ?>">
    ...
    <div class="StreamBlockInside StreamBlockInsideTimelineEffortPlanning">
        <label>
            Workload(planning) <input data-tid="<?php echo $timeline['id']; ?>" type="number" min="0" class="TextInput StreamTimelinePlanningEffortInput" value="<?php echo $timeline['effort']; ?>" /> wdays&nbsp;&nbsp;<span class="ZWHelpPopup QTip QTipPermanent" title="This is estimation(planning) workload spend for this timeline">help</span>
        </label>
    </div>
