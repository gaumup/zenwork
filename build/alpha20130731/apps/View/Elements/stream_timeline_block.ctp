...
<div class="StreamBlock StreamTimelineBlock <?php if ( $timeline['completed'] ) : ?>StreamTimelineBlockDone<?php endif; ?>" id="streamTimelineBlock<?php echo $timeline['id']; ?>">
    ...
    <div class="StreamBlockInside">
        <label>From <span data-id="<?php echo $timeline['id']; ?>" class="StreamDateTime StreamDateTimeStart"><?php echo date('d-M-Y', $timeline['start']); ?></span> To <span data-id="<?php echo $timeline['id']; ?>" class="StreamDateTime StreamDateTimeEnd"><?php echo date('d-M-Y', $timeline['end']); ?></span>&nbsp;&nbsp;&nbsp;<span id="streamTimelineWDays<?php echo $timeline['id']; ?>"><?php echo $wdays; ?></span> wdays</label>

        <?php if ( !$hasChild && ($isCreator || $isOwner) ) : ?>
            <a data-id="streamTimelineBlockEditTimeline<?php echo $timeline['id']; ?>" href="#b<?php echo $timeline['id']; ?>" title="Edit" class="StreamTimelineBlockEditTimeline" data-start="<?php echo $timeline['start']; ?>" data-end="<?php echo $timeline['end']; ?>" data-wdays-id="streamTimelineWDays<?php echo $timeline['id']; ?>">Edit timeline</a>
        <?php endif; ?>
    </div>
    ...
    <div class="StreamBlockInside">
        ...
        <?php if ( !$hasChild && ($isCreator || $isOwner) ) : ?>
        <a rel="#streamAssigneeList<?php echo $timeline['id']; ?>" data-tid="<?php echo $timeline['id']; ?>" data-id="streamTimelineBlockEditAssignee<?php echo $timeline['id']; ?>" href="#b<?php echo $timeline['id']; ?>" title="Edit" class="StreamTimelineBlockEditAssignee">Edit assignee</a>
        <?php endif; ?>
