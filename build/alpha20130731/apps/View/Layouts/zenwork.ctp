...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo Configure::read('root_url'); ?>/widgets/tour/css/joyride.css" />
...
<body>
    ...
    <script type="text/javascript" src="<?php echo Configure::read('root_url'); ?>/widgets/tour/js/joyride.js"></script>
