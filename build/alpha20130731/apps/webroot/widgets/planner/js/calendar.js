...
(function($) {
	$.widget('ui.calendar', {
        ...
        //destructor
            _destroy: function () {
                //destroy add-ons
                this.options.dayRow.selectable('destroy');
                //clear event
                $(window).off('.calendar');
        ...
        //public method
            ...
            getDayValue: function (position, width) {  //TODO: working time should be fully customized
                ...
                var tmpStartDate = this.options.startTime.valueOf() + tmp1*43200000;
                var tmpEndDate = tmpStartDate + tmp2*43200000;
                ...
                return {
                    start: Math.round(startDate.valueOf()/1000), //ms -> s
                    end: Math.round(endDate.valueOf()/1000) //ms -> s
                }
            },
