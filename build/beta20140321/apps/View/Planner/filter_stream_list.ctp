<h3 id="streamDialogTitle"><span class="StreamDetailsTitle">Filter task</h3>

<div class="StreamContentWrapper">
    <div class="StreamContentInside">
        <div class="StreamBlock">
            <h4>View task asigned to people &ndash; <label for="toggleListInvitedPeople"><input type="checkbox" id="toggleListInvitedPeople" /> toggle all</label></h4>
