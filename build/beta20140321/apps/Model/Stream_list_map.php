    ...
    class Stream_list_map extends AppModel {
        ...
        public function save ($data=null, $validate=true, $fieldList=array()) {
            ...
            if ( isset($data['Stream_list_map']) ) {
                $this->Behaviors->load('StreamTree', array('scope' => 'Stream_list_map.lid = '.$data['Stream_list_map']['lid']));
        ...
        public function delete ($id = null, $cascade = true) {
            $this->id = $id;
            $slm = $this->read();
            $this->Behaviors->load('StreamTree', array('scope' => 'Stream_list_map.lid = '.$slm['Stream_list_map']['lid']));
