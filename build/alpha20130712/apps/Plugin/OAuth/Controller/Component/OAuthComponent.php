 ...
 */
	public function invalidateUserTokens($user_id, $client_id, $tokens = 'both') {
...
/**
 * Function to delete expired AccessTokens
 *
 *
 * @param int $oauth_token (AccessToken's id)
 */
	public function deleteExpiredAccessToken($oauth_token) {
        $this->AccessToken->delete($oauth_token);
	}
...
/**
 * Function to delete user's AuthCode when user logout
 * useful when user is deleted or client id changed
 *
 * @param int $oauth_token (AccessToken's id)
 */
	public function deleteDeprecatedAuthCode($user_id, $client_id) {
