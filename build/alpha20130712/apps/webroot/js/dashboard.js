...
jQuery(document).ready(function () {
    (function($) {
        ...
        //draw user task statistic chart
        Zenwork.Dashboard.UserStatisticChart = function () {
            //Get the context of the canvas element we want to select
            var userStatisticCanvas = $('#myTaskStatistic');
            var userStatisticChartContext = userStatisticCanvas.get(0).getContext('2d');
            var _drawUserStatisticChart_ = function () {
                userStatisticCanvas.attr('width', userStatisticCanvas.parent().width());
                return new Chart(userStatisticChartContext).Line(
                    {
                        labels : ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
                        datasets : Zenwork.Dashboard.UserStatisticChart.Model.getDatasets()
                    },
                    $.extend(Zenwork.Chart.Line.defaults, {
                        scaleOverride : true,
                        scaleSteps : 10,
                        scaleStepWidth : 20,
                        scaleStartValue : 0,
            ...
            var _reDraw_ = function () {
                userStatisticChartContext.clearRect(0, 0, userStatisticCanvas.attr('width'), userStatisticCanvas.attr('height'));
                userStatisticChart = _drawUserStatisticChart_();
            }
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                $.each(data.today, function (index, value) {
                    todayTaskList.tasklist('addNewStream', value.Stream);
                });
                ...
                //draw chart
                $('#chartBlock').removeClass('ZWPending');
                Zenwork.Dashboard.UserStatisticChart.Model.setDatasets({
                    planning: { //planning
                        fillColor : 'rgba(220, 220, 220, 0.5)',
                        strokeColor : 'rgba(220, 220, 220, 1)',
                        pointColor : 'rgba(220, 220, 220, 1)',
        ...
        Zenwork.Plugins.jScrollPane.call(todayTaskListjsp, {verticalGutter: 5}); //init jscrollpane for todayTaskList
    ...
    $.widget('ui.tasklist', $.ui.stream, {
        ...
        //options
            options: {
                cssClass: {
                    streamTag: 'StreamTag',
                    streamTagTask: 'StreamTagTask',
                    streamTagBug: 'StreamTagBug',
                    streamTagApproval: 'StreamTagApproval',
        ...
        //private method
            _addNewStream: function (data, isAjax, position, callback) {
                ...
                var _util_ = function (data) {
                    ...
                    var streamElement = $(
                        ...
                        '        <div class="'+opts.cssClass.streamField+' '+opts.cssClass.streamTag+'">Task</div>'+
            ...
            _ajustDialogSize: function () {
                ...
                var bottomSpacing = 75;

                this.options.streamDialog.css({
                    width: $windowBoxModel.width - $streamDialogPosition.leftAbs - 15,
                ...
                if ( Zenwork.AssigneeDialog !== undefined ) {
                    ...
                    Zenwork.StreamPopup.wrapper.on( //assign
                        ...
                        function (e, assigneeData) {
                            ...
                            //$('#streamTimelineBlock'+tid).data('User').push(assigneeData);
                        });
