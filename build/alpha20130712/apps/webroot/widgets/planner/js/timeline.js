        ...
        //constructor
            _create: function () {
                ...
                this.timelineInnerDOM += String(
                    ...
                    ( isCreator
                        ? (
                            '<a href="#" class="QTip '+opts.cssClass.timelineBtn+' '+opts.cssClass.relationshipPoint+' '+opts.cssClass.relationshipPointLeft+'" title="Drag to create relationship">Drag to create relationship</a>'+
                            '<a href="#" class="QTip '+opts.cssClass.timelineBtn+' '+opts.cssClass.relationshipPoint+' '+opts.cssClass.relationshipPointRight+'" title="Drag to create relationship">Drag to create relationship</a>'
                        ) : ''
                    )+
                ...
                element.find('.'+opts.cssClass.timelineBtn)
                    ...
                    .bind('click.timeline', function (e) {
                        ...
                        else if ( $this.hasClass(opts.cssClass.timelineCalendarBtn) ) { //edit
                ...
                element.on(Zenwork.AssigneeDialog.EVENT.UNASSIGN, function (e, uid, allCompleted) {
                    ...
                    var assigneeStr = assigneeData.length === 0 ? 'Assignee: [no assignee]' : self._util_.getAssigneeStr(assigneeData);
                    element.find('.'+opts.cssClass.timelineAssignBtn)
                        .attr('title', assigneeStr)
                        .text(assigneeStr);
                });
        ...
        //private method
            ...
            _deleteTimeline: function (e, callback) {
                ...
                Zenwork.Window.confirm('Sure?', function () {
                    $.ajax({
                        type: 'POST',
                        url: Zenwork.Root+'/gantt2/deleteTimeline/'+element.data('id'),
