    ...
    class Stream extends AppModel {
        ...
        public $belongsTo = array(
            'Creator' => array(
                ...
                'conditions' => array('Creator.is_blocked <>' => 1)
            )
        );
        ...
        public function getDetais ($sid, $lid=null) {
        ...
        public function beforeDelete ($cascade=true) {
            $this->deleteAll(array('Stream.parentID' => $this->id), true/*cascade*/, true/*run callbacks*/);
            return true;
        }
    }
?>
