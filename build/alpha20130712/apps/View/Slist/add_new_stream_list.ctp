<h3 id="streamDialogTitle"><span class="StreamDetailsTitle"><?php if ( isset($streamList) ) : ?>Edit selected plan<?php else : ?>Create a new plan<?php endif; ?></span></h3>
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <div class="StreamBlock">
                    ...
                    <input type="text" class="TextInput" placeholder="Plan name" id="newPlanName" value="<?php if ( isset($streamList) ) { echo htmlspecialchars($streamList['Stream_list']['name']); } ?>" />
                ...
                <div class="StreamBlock">
                    ...
                    <textarea class="Textarea AutoResizeTextbox" placeholder="Description" id="newPlanDescription"><?php if ( isset($streamList) ) { echo htmlspecialchars($streamList['Stream_list']['description']); } ?></textarea>
                </div>
