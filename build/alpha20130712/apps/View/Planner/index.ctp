<?php
    $this->Css->add('/css/planner.css', false);
    ...
    <div class="Invisible">
        <div id="ganttTimelineToolbar" class="GanttTimelineToolbar">
            <div class="FilterBlock">
                ...
                <a href="#" id="createNewStreamList" title="Create a new plan" class="CommonButtonLnk CommonButtonLnkSmall">Create new +</a>
                <a href="#" id="editSelectedStreamList" title="Edit selected plan" class="CommonButtonLnk CommonButtonLnkSmall">Edit</a>
            </div>
            ...
            -->
            <a href="#" title="People" class="CommonButtonLnk CommonButtonLnkSmall CommonButtonLnkCompact GanttPeople GanttToolbarBtn" id="manageUserList">People</a>
            <a href="#" title="Tag" class="CommonButtonLnk CommonButtonLnkSmall CommonButtonLnkCompact GanttTag GanttToolbarBtn" id="manageTagList">Tag</a>
            ...
            <a href="" id="addGanttTimelineTrigger" title="Add new task" class="CommonButtonLnk CommonButtonLnkSmall GanttToolbarBtn">Add new task</a>
        </div>
            ...
            <div id="streamContainer" class="StreamContainer">
                <table width="100%" cellpadding="0" cellspacing="0">
                    <thead id="streamHeader" class="StreamHeader">
                        <tr>
                            <th colspan="7" class="SearchStreamWrapper"><input type="text" placeholder="Type and press enter to highlight matched row" id="streamSearchBox" class="QTip" data-qtip-my="left center" data-qtip-at="right center" title="Type and press enter to highlight matched row" /></th>
                        </tr>
                        <tr>
                            ...
                            <th width="39" class="CenterCol">No</th>
                            <th width="19" class="CenterCol"><span title="Dragging icon on this column to reorder rows in list" class="QTip HeaderHelpIcon" data-qtip-my="bottom left" data-qtip-at="top right">Dragging icon on this column to reorder rows in list</span></th>
                            <th width="19" class="CenterCol"><span title="Click icon on this column to open action menu for each row(eg. indent, outdent, cut, copy, share, follow, delete...)" class="QTip HeaderHelpIcon" data-qtip-my="bottom left" data-qtip-at="top right">Click icon on this column to open action menu for each row(eg. indent, outdent, cut, copy, share, follow, delete...)</span></th>
