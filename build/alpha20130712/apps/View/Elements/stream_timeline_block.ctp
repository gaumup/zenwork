...
<div class="StreamBlock StreamTimelineBlock <?php if ( $timeline['completed'] ) : ?>StreamTimelineBlockDone<?php endif; ?>" id="streamTimelineBlock<?php echo $timeline['id']; ?>">
    ...
    <div class="StreamBlockInside">
        ...
        <a rel="#streamAssigneeList<?php echo $timeline['id']; ?>" data-id="streamTimelineBlockEditAssignee<?php echo $timeline['id']; ?>" href="#b<?php echo $timeline['id']; ?>" title="Edit" class="StreamTimelineBlockEditAssignee">Edit assignee</a>
        <?php endif; ?>
