        ...
        <div class="ZWHelpBoardContentWrapper">
            <ul class="ZWHelpTourContent" id="zwHelpTour">
                ...
                <li data-slide="Dashboard">
                    ...
                    <div class="ZWHelpTourExtras">
                        <div class="ImageGuideBlock">
                            <img src="images/tour-dashboard.png" alt="Dashboard" />
                            ...
                            <span id="imageGuideBlockSpotMonthlyWorkloadChart" title="Your monthly workload chart: showing your workload by each month in chart view. It contains 2 line for planning workload and actual workload which you have spent" class="QTip QTipPermanent ImageGuideBlockSpot">Your monthly workload chart: showing your workload by each month in chart view. It contains 2 line for planning workload and actual workload which you have spent</span>
                        </div>
                    </div>
                </li>
                ...
                <li data-slide="Task Planner">
                    ...
                    <div class="ZWHelpTourExtras">
                        <div class="ImageGuideBlock">
                            <img src="images/tour-planner.png" alt="Dashboard" />
