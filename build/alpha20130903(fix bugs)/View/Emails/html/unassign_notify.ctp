<?php
    ...
    echo '<p>'.$assigner.' un-assign you from task <strong>"'.htmlspecialchars($stream['name']).'"</strong>. Timeline from <strong>'.date('d-M-Y', $timeline['start']).'</strong> to <strong>'.date('d-M-Y', $timeline['end']).'</strong></p>';
