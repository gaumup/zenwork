        ...
        //options
            options: {
                ...
                cssClass: {
                    ...
                    timelineAssignee: 'GanttTimelineAssignee'
                },
                //callback
        ...
        //constructor
            _create: function () {
                ...
                this.timelineInnerDOM += String(
                    ...
                    '<span class="'+opts.cssClass.timelineAssignee+'">'+assigneeStr.compact+'</span>'+
                    ...
                    ( isCreator || isOwner
                        ? (
                            '<a href="#'+opts.clientID+'" class="QTip '+opts.cssClass.timelineBtn+' '+opts.cssClass.timelineAssignBtn+'" title="'+assigneeStr.full+'">'+assigneeStr.full+'</a>'+
                ...
                element.on(Zenwork.AssigneeDialog.EVENT.ASSIGN, function (e, assigneeData) {
                    ...
                    element.find('.'+opts.cssClass.timelineAssignee).text(assigneeStr.compact);
                });
