...
<!--
    <div class="DashboardHrWrapper">
        <hr class="DashboardHr" />
    </div>
    
    <div class="TeamManagementHeader">
        <h2 class="TeamManagementTitle">Team management</h2>
        <div class="FilterBlock">
            <div class="FilterBlockSelectionWrapper">
                <input id="teamAutoSuggestDashboard" type="text" class="QTip TextInput TeamSelectionInput" title="Type search or select a team" placeholder="Type search or select a team" data-qtip-my="right center" data-qtip-at="left center" />
                <span class="ListSelectionEdge"></span>
                <a href="#" id="editSelectedTeam" title="Edit/delete current selected team" class="QTip CommonButtonLnk CommonButtonLnkSmall EditTeamBtn" data-qtip-my="top center" data-qtip-at="bottom center">Edit</a>
            </div>
            ...
            <a href="#" title="Manage people in this team: invite new people, remove exsiting people" class="QTip CommonButtonLnk CommonButtonLnkCompact InvitePeopleTeam" id="manageUserTeam" data-qtip-my="right center" data-qtip-at="left center">Manage people in this team</a>
        </div>
    </div>
    ...
    <div id="teamBlock" class="ZWBlock ZWBlockFullExpand">
        <div class="ZWBlockInner">
            <div class="ZWSection">
                <div class="ZWBlockHeader">
                    <h2>Team resource usage(<?php echo date('M-Y', time()); ?>)</h2>
                    <ul class="ZWUserStatisticLabel">
                        <li class="ZWUserStatisticLabelItem01"><span class="ZWUserStatisticLabelImg">&nbsp;</span> <em>planning</em> <span class="ZWHelpPopup QTip QTipPermanent" title="Total workload of all tasks <strong>assigned to you</strong>">help</span></li>
                ...
                <div id="teamResourceChartBlock" class="ZWChartBlock ZWChartBlockAlt01 ZWPending">
                    <canvas id="teamResourceStatistic" height="460"></canvas>
                </div>
            </div>
            ...
            <div class="ZWSection">
                <div class="ZWBlockHeader">
                    ...
                    <ul class="ZWUserStatisticLabel">
                        <li class="ZWUserStatisticLabelItem01"><span class="ZWUserStatisticLabelImg">&nbsp;</span> <em>planning</em> <span class="ZWHelpPopup QTip QTipPermanent" title="Total workload of all tasks <strong>assigned to you</strong>">help</span></li>
                        <li class="ZWUserStatisticLabelItem02"><span class="ZWUserStatisticLabelImg">&nbsp;</span> <em>completed</em> <span class="ZWHelpPopup QTip QTipPermanent" title="Total workload of all tasks <strong>assigned to team members</strong> and <strong>completed</strong>(task completion are update by each team members)">help</span></li>
                    </ul>
                </div>

                <div id="teamProgressBurndownChartBlock" class="ZWChartBlock ZWChartBlockAlt01 ZWPending">
                    <canvas id="teamProgressBurndown" height="460"></canvas>
                </div>
            </div>
        </div>
    </div>
