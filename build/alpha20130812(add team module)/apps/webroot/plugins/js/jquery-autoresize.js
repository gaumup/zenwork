...
/* NOTE: edit by ukhome@gmail.com, do not update */

(function($) {
	var defaultOptions = {
        container: 'body', //body or id of DOM container
		...
		return this.each(function() {
            ...
            if ( _options.container != 'body' ) {
                ...
                if ( _container.length == 0 ) {
                    _container = $('<div id="autoresize_helper"></div>').appendTo('body');
                }
            }
            else {
                _container = $('body');
			...
			var textarea = $(this).css({'overflow-y': 'hidden'}),
				clone = (function() {
					...
					return textarea.clone().css(css).removeAttr('id').removeAttr('name').attr('tabIndex', '-1').appendTo(_container);
				})(),
				oneline = (function() {
				...
				eventListener = function (e) {
                    ...
                    if (height !== last_height) {
                        var _scrollTop = textarea.scrollTop();
