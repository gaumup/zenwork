                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <thead id="streamHeader" class="StreamHeader">
                        ...
                        <tr>
                            ...
                            <th width="54" class="RightCol NoPaddingHorz">No <span class="ZWHelpPopup ZWHelpPopupAlt02 QTip QTipPermanent" title="Drag icon next to index number to reorder task" data-qtip-my="left center" data-qtip-at="right center">Drag icon next to index number to reorder task</span></th>
...
<div class="ZWContainer">
    ...
    <div id="relationshipDialog" class="ZWContextDialog RelationshipDialog Hidden">
