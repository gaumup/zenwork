                ...
                <div class="ProfileWrapper01">
                    <div class="FormRow">
                        ...
                        <div class="FieldContainer">
                            ...
                            <p class="PhotoNotice">This photo is your identity on Zenwork and appears with your account</p>
...
<div id="helper_container">
    <div id="edit_avatar_context_menu" class="CommonContextMenu Hidden">
        <ul class="EditAvatarOptions">
            <li><a href="#upload_avatar" title="Upload an image" class="UploadImgIcon">Upload an image(max 2MB)<iframe src="<?php echo Configure::read('root_url').'/auth/uploadAvatar/'.$this->Session->read('Auth.User.id') ?>" class="IframeUpload"></iframe></a></li>
