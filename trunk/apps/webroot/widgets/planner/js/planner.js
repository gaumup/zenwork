        ...
        $('#filterStreamList').on('click', function (e) {
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    var checkboxes = $('.UserTaskViewCheckbox');
                    var toggleAllCheckbox = $('#toggleListInvitedPeople');
                    var _util_ = function () {
                        if ( checkboxes.filter(':checked').length == checkboxes.length ) {
                            toggleAllCheckbox.attr('checked', 'checked');
                        }
                        else {
                    ...
                    toggleAllCheckbox.on('change', function (e) {
                        if ( $(this).is(':checked') ) {
